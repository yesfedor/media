...
export default createStore({
  state: {
    ...
    versions: [
      {
        version: 'media-v6.0.0',
        title: 'Новое ядро, работа с авторизацией',
        date: '18.07.2021',
        text: `
        <span class="mb-3">Список изменений:</span>
        <ul class="pl-1 pl-lg-4">
          <li>Переезд на новое ядро</li>
          <li>всвязи с 1п. был произведен сброс всех данных пользователей, приношу извинения за неудобства</li>
          <li>Изменение авторизации пользователя</li>
          <li>Закрытое тестирование комментариев на сайте </li>
        </ul> 
        `
      },
      {
